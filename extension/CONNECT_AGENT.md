...
Code restore point for this architecture discussion: git commit `0605632` on branch `master` (“Checkpoint: DOM→WebMCP Chrome extension + demo shop”). Agent-connect docs land in the following commit.
